...
python run_experiment.py --config configs/epistemic_showcase_near.json --out-dir figures/epistemic_showcase_near/ \
...
python run_reject_option_experiment.py --config configs/epistemic_showcase_near.json --out-dir figures/epistemic_showcase_near/ \
    --n-eval 2000  --sweep --trials 10 --m-train 10000 --sizes 50 100 200 500 1000 2000 5000 
...
python run_experiment.py --config configs/model1.json --out-dir figures/model1/ \
    --n-eval 2000 --m-train 10000 --sweep --sizes 1 2 5 10 20 50 100 200 1000 2000 5000
...
python run_experiment.py --config configs/model2.json --out-dir figures/model2/ \
    --n-eval 2000 --m-train 10000 --sweep --sizes 1 2 5 10 20 50 100 200 1000 2000 5000
