...
python run_base_predictor_exp.py octmnist runs/octmnist_noadapt --epochs 30 --device cuda

python run_base_predictor_exp.py organamnist runs/organamnist_noadapt --epochs 30 --device cuda

python run_base_predictor_exp.py tisuemnist runs/tisuemnist_noadapt --epochs 30 --device cuda
